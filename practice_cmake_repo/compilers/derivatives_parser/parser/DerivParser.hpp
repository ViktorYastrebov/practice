...
#line 172 "DerivParser.hpp"
   ...
   enum yytokentype {
     ...
     KW_TAN = 266,
     KW_E_IDENTIFIER = 267,
     KW_PI_IDENTIFIER = 268,
     KW_DOT = 269,
     KW_LPAREN = 270,
     KW_RPAREN = 271,
     KW_NUMBERS = 272,
     KW_IDENTIFIER = 273,
     KW_CONSTANTS_IDENTIFIER = 274,
     KW_DOUBLE_LITERAL = 275
   };
    ...
    DerivParser (ParserCtx& driver_yyarg);
    virtual ~DerivParser ();
...
/* Line 35 of lalr1.cc  */
#line 379 "DerivParser.hpp"


/* "%code provides" blocks.  */

/* Line 35 of lalr1.cc  */
#line 26 "original_gramma.yy"
